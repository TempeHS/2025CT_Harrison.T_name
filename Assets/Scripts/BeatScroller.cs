...
public class BeatScroller : MonoBehaviour
{
    ...
    private List<List<NoteSpawnInfo>> beatMap = new List<List<NoteSpawnInfo>>
    {
        ...
        new List<NoteSpawnInfo> { new NoteSpawnInfo(1) }, // Left
        new List<NoteSpawnInfo> { new NoteSpawnInfo(3) }, // Down
        new List<NoteSpawnInfo> { new NoteSpawnInfo(2) }, // Up
        new List<NoteSpawnInfo> { new NoteSpawnInfo(0) }, // Right

        new List<NoteSpawnInfo> { new NoteSpawnInfo(3), new NoteSpawnInfo(1) }, // Left & Down Chord
        new List<NoteSpawnInfo> { new NoteSpawnInfo(2), new NoteSpawnInfo(0) }, // Up & Right Chord
        new List<NoteSpawnInfo> { },                                         // Empty beat
        new List<NoteSpawnInfo> { new NoteSpawnInfo(0), new NoteSpawnInfo(1) }, // Left & Right Chord
        ...
        new List<NoteSpawnInfo> { new NoteSpawnInfo(2), new NoteSpawnInfo(3), new NoteSpawnInfo(2), new NoteSpawnInfo(3) }, // All Four Notes!
